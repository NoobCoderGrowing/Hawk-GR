...
public class KaeTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Reserved range: [" + config.reservedMin() + ", " + config.reservedMax() + "]");
        ...
        String modified = KaeEncoder.setReservedSlot(sid2, 'd', 2000);
        System.out.println("  After set d=2000: " + modified);
        System.out.println("  d_2000 is reserved: " + config.isReservedSlot(2000));
        System.out.println("  d_5 is reserved: " + config.isReservedSlot(5));

        // Test 5: Parse
        System.out.println("\n--- Test 5: parse SID ---");
        int[] parsed = KaeEncoder.parseSid("<a_304><b_1><c_13><d_2000><e_0><f_197>");
